...
public class posts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        adapterC = new AdapterC(this, list);
        ...
        nDatabaseRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    DatabaseC crnt = dataSnapshot.getValue(DatabaseC.class);
    ...
    public void btnKomen(View view) {
        ...
        pd.show();
        //inisialisasi objek
        DatabaseC cmnt = new DatabaseC(nUsr, comments.getText().toString(), imageid);
        ...
        nDatabaseRef.push().setValue(cmnt).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()) {
                    //memunculkan toast
                    Toast.makeText(posts.this, "You commented on this post", Toast.LENGTH_SHORT).show();
                    //set field menjadi kosong kemali
                    comments.setText(null);
                } else {
                    //apabila tidak berhasil maka muncul toas berisi gagal menambah komen
                    Toast.makeText(posts.this, "Failed to add comment", Toast.LENGTH_SHORT).show();
                }
                //menutup dialog
                pd.dismiss();
            }
